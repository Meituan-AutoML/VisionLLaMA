...
def SiTLLaMA_XL_2(**kwargs):
    return SiTLLaMA(depth=28, hidden_size=1152, patch_size=2, num_heads=16, **kwargs)
...
def SiTLLaMA_L_2(**kwargs):
    return SiTLLaMA(depth=24, hidden_size=1024, patch_size=2, num_heads=16, **kwargs)
...
def SiTLLaMA_B_2(**kwargs):
    return SiTLLaMA(depth=12, hidden_size=768, patch_size=2, num_heads=12, **kwargs)
...
def SiTLLaMA_S_2(**kwargs):
    return SiTLLaMA(depth=12, hidden_size=384, patch_size=2, num_heads=6, **kwargs)
...
SiT_models = {
    ...
    'SiTLLaMA_XL_2': SiTLLaMA_XL_2, 'SiTLLaMA_B_2': SiTLLaMA_B_2, 'SiTLLaMA_L_2': SiTLLaMA_L_2, 'SiTLLaMA_S_2': SiTLLaMA_S_2
}
