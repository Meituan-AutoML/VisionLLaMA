...
@OPTIM_WRAPPER_CONSTRUCTORS.register_module()
class MyLearningRateDecayOptimizerConstructor(DefaultOptimWrapperConstructor):
    """Different learning rates are set for different layers of backbone.
            ...
            if 'layer_wise' in decay_type:
                if 'ConvNeXt' in module.backbone.__class__.__name__:
                    ...
                    print_log(f'set param {name} as id {layer_id}')
                     ...
                     'VisionLLaMA' in module.backbone.__class__.__name__ or \
                     'VisionTransformer' in module.backbone.__class__.__name__ or \
                     'LLaMADET' in module.backbone.__class__.__name__:
